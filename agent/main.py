...
# Importar tools registra la tabla "leads" en el metadata de SQLAlchemy antes de que
# inicializar_db() corra el create_all. Sin este import la tabla no se crea y el
# primer registro de un prospecto falla.
